...
detailsSound.setAttribute("muted", true);
...
function setDetails(anchor) {
    ...
    //get element with class thumbnails-sound inside the given anchor
    let thumbnailsSoundlector = `[href="${hrefValue}"] .thumbnails-sound`;
    ...
    detailsSound.setAttribute("src", srcValue);
}
